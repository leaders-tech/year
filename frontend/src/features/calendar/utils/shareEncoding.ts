/*
This file keeps legacy URL-safe JSON encoding helpers for old imported calendar links.
Edit this file when legacy share decoding behavior changes.
Copy this file only when another feature needs URL-safe payload encoding.
*/
