/*
This file keeps month range helpers for calendar views.
Edit this file when month pointer parsing or range math changes.
Copy this file when another feature needs month-range utilities.
*/
