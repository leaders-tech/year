/*
This file defines calendar colors, textures, day-cell data, and color helpers.
Edit this file when available calendar marks or color application behavior changes.
Copy this file when another calendar feature needs the same day-cell data model.
*/
