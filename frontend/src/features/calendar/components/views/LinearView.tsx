/*
This file renders the full-width linear week calendar view.
Edit this file when the linear calendar grid behavior changes.
Copy this file when you add another date-grid view.
*/
...
const LinearView: React.FC<LinearViewProps> = ({ monthRange, dateCells, setDateCells, selectedColorTexture, canEdit }) => {
                    ...
                    >
                      ...
                      >
                        <Day
                          ...
                          onMouseDown={canEdit ? () => handleMouseDown(day) : undefined}
                          onMouseEnter={canEdit ? () => handleMouseEnter(day) : undefined}
                          onCustomTextChange={canEdit ? (text) => handleCustomTextChange(day, text) : undefined}
