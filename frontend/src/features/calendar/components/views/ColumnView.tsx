/*
This file renders the month-column calendar view.
Edit this file when the column calendar grid behavior changes.
...
const ColumnView: React.FC<ColumnViewProps> = ({ monthRange, dateCells, setDateCells, selectedColorTexture, canEdit }) => {
