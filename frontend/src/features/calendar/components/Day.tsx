/*
This file renders one calendar day cell with color, texture, and optional text.
Edit this file when day-cell interaction or display rules change.
Copy this file when another calendar grid needs the same editable day behavior.
*/
...
const Day: React.FC<DayProps> = ({
  ...
  const canEdit = Boolean(onClick || onMouseDown || onMouseEnter || onCustomTextChange)
