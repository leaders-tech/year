/*
This file renders and edits custom text inside a calendar day cell.
Edit this file when inline day text editing behavior changes.
Copy this file when another grid needs the same content-editable label.
*/
