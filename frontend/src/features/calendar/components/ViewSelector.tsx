/*
This file renders the calendar view selector.
Edit this file when view names or view switching controls change.
Copy this file when another page needs the same segmented selector.
*/
