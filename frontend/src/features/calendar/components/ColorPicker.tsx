/*
This file renders color and texture swatches for editable calendars.
Edit this file when available colors, textures, or selection UI changes.
Copy this file when another planner needs the same swatch picker.
*/
